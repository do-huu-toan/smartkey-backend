...
exports.HttpErrorNotAuthorize = void 0;
...
var HttpErrorNotAuthorize = /** @class */ (function (_super) {
    ...
    function HttpErrorNotAuthorize() {
        return _super.call(this, 500) || this;
    }
    HttpErrorNotAuthorize.prototype.toJSON = function () {
        return {
...
exports.HttpErrorNotAuthorize = HttpErrorNotAuthorize;
